...
ActiveRecord::Schema.define(version: 2021_05_31_075200) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["piece_id"], name: "index_orders_on_piece_id"
  ...
  add_foreign_key "orders", "pieces"
  add_foreign_key "orders", "users"
  add_foreign_key "parts", "pieces"
